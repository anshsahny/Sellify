import { Button, ButtonGroup, Container, Divider, IconButton, Input, Stack, Text, Box, useColorModeValue, Flex, Icon } from '@chakra-ui/react'
            ...
            <Container as="footer" role="contentinfo" maxW='7xl'>
                <Stack spacing="8" direction={{ base: 'column', md: 'row' }} justify="space-between" py={{ base: '12', md: '16' }}>
                    <Stack spacing={{ base: '6', md: '8' }} align="start">
                        <Flex alignItems='center'>
                            ...
                            <Text fontSize='2xl' fontWeight='extrabold' ml='5px'>
                                Sellify
                            </Text>
                        </Flex>
                        <Text color="muted">Selling love with our products!</Text>
                    </Stack>
                ...
                <Stack pt="8" pb="12" justify="space-between" direction={{ base: 'column-reverse', md: 'row' }} align="center">
                    <Text fontSize="sm" color="subtle">
                        &copy; {new Date().getFullYear()} Sellify, Inc. All rights reserved.
                    </Text>
